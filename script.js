...
// Note: For tasks 5, 6, and 7, you can assume that the HTML elements with the IDs 'myButton' and 'parentElementId' exist in the HTML document. However, since this is a JavaScript file, you won't be able to actually select the elements or see the results of the DOM manipulation in this file. You can test these tasks in an actual HTML document.
